...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            FARAZ
\033[1;37m Facebook:            FARAZ
\033[1;37m My GF  :            I Love You ❤️ Shahnela ❤️
...
def cutter():
    ...
    os.system('touch ' +FARAZ)
    os.system('sort -r '+ssb+' | uniq > '+FARAZ)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + FARAZ )
    print(47*'-')
